...
TOUR_PACKAGES = [
    {
        ...
        "duration_h": 7,
        "lang": ["el", "en"],
        "includes": ["μεταφορά", "διόδια/τέλη", "παιδικά καθίσματα κατόπιν ζήτησης"],
        "excludes": ["εισιτήρια μουσείων/χώρων", "ξεναγός", "γεύματα"],
        "notes": [
        ...
        "highlights": [
            "Γέφυρα Ρίου–Αντιρρίου", "Κάστρο Ναυπάκτου", "Γαλαξίδι",
    ...
    },
    {
        ...
        "duration_h": 7,
        "lang": ["el", "en"],
        "includes": ["μεταφορά", "τέλη", "παιδικά καθίσματα κατόπιν ζήτησης"],
        "excludes": ["εισιτήρια", "ξεναγός", "γεύματα"],
        "notes": [
            "Σταθερή τιμή για 1–4 άτομα",
            "Ώρα εκκίνησης: 08:00–10:00 από το κατάλυμά σας",
            "Τα παιδιά προσμετρούνται στον αριθμό επιβατών",
        ...
        "highlights": [
            "Ναός Δία/Ήρας", "Στάδιο", "Αρχαιολογικό Μουσείο Ολυμπίας",
        ],
    },
]
...
EXCURSION_PACKAGES = [
    {
        ...
        "book_url": BRAND_INFO["booking_url"],
